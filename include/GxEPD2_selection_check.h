...
#endif
#if IS_GxEPD2_4C(GxEPD2_DISPLAY_CLASS) &&                                      \
    IS_GxEPD2_DRIVER_BW(GxEPD2_DRIVER_CLASS)
...
#endif
#if IS_GxEPD2_7C(GxEPD2_DISPLAY_CLASS) &&                                      \
    !IS_GxEPD2_DRIVER_7C(GxEPD2_DRIVER_CLASS)
#error "GxEPD2_7C used with less colors driver class"
#endif
#if !IS_GxEPD2_DRIVER_BW(GxEPD2_DRIVER_CLASS) &&                               \
    !IS_GxEPD2_DRIVER_3C(GxEPD2_DRIVER_CLASS) &&                               \
    !IS_GxEPD2_DRIVER_4C(GxEPD2_DRIVER_CLASS) &&                               \
    !IS_GxEPD2_DRIVER_7C(GxEPD2_DRIVER_CLASS)
#error                                                                         \
